...
function () {
  ...
  return function passwordInput(_x2) {
...
/*#__PURE__*/
function () {
  var _ref3 = _asyncToGenerator(function* (email, password, userName, tenantName) {
    try {
  ...
  return function sdkSignUp(_x3, _x4, _x5, _x6) {
...
/*#__PURE__*/
function () {
  var _ref4 = _asyncToGenerator(function* (inquirer, email = null) {
  ...
  run(serverless) {
    return _asyncToGenerator(function* () {
      ...
      if (!(yield inquirer.prompt({
        ...
        process.stdout.write('If you have a Serverless account you can run “serverless login” to\n' + 'login and then run “serverless” again to finish setup.\n');
        return null;
      }

      const _ref5 = yield signUp(inquirer),
            ownerUserName = _ref5.ownerUserName,
            tenantName = _ref5.tenantName,
            ownerAccessKey = _ref5.ownerAccessKey,
            ownerAuth0Id = _ref5.ownerAuth0Id;
